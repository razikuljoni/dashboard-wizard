...
// const CMAverageStrikeRateByDate = ({ data }) => {
...
//     return (
//         <div className="px-5 py-2" id="cm-average-strike-rate-by-date">
//             <div className="p-3 bg-white rounded-lg shadow">
//                 <ChartHeader
//                     title="CM Average Strike Rate By Date"
//                     cssId="cm-average-strike-rate-by-date"
...
// export default CMAverageStrikeRateByDate;
