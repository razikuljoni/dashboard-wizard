...
// const MSAverageStrikeRateByDate = ({ data }) => {
//     const [chartData, setChartData] = useState([]);

//     useEffect(() => {
//         setChartData(data?.map(x => ({ date: x.day, value: x.average })));
//     }, [data?.length]);
...
//                         y2: 1,
//                         colorStops: [
//                             { offset: 0, color: '#5c67f7' }, // Top color
//                             { offset: 1, color: 'rgba(92,103,247,0)' }, // Bottom transparent color
//                         ],
//                     },
//                 },
//             },
...
//     return (
//         <div className="px-5 py-2" id="ms-average-strike-rate-by-date">
//             <div className="p-3 bg-white rounded-lg shadow">
//                 <ChartHeader
//                     title="MS Average Strike Rate By Date"
//                     cssId="ms-average-strike-rate-by-date"
...
// export default MSAverageStrikeRateByDate;
