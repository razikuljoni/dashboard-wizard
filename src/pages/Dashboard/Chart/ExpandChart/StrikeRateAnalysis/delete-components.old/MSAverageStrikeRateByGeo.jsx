...
// const MSAverageStrikeRateByGeo = ({ data }) => {
...
//     return (
//         <div className="px-5 py-2" id="ms-average-strike-rate-by-geography">
//             <div className="p-3 bg-white rounded-lg shadow">
//                 <ChartHeader
//                     title="MS Average Strike Rate By Geography"
//                     cssId="ms-average-strike-rate-by-geography"
...
// export default MSAverageStrikeRateByGeo;
