...
const PlanogramGhwGeo = ({ data }) => {
    ...
    return (
        <div className="px-5 py-2" id="planogram-ghw-average-by-geography">
            <div className="p-3 bg-white rounded-lg shadow">
                <ChartHeader
                    title="Planogram GHW Average By Geography"
                    cssId="planogram-ghw-average-by-geography"
...
export default PlanogramGhwGeo;
