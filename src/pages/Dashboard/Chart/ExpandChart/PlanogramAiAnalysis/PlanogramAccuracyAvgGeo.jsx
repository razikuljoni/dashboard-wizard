...
const PlanogramAccuracyAvgGeo = ({ data }) => {
    ...
    return (
        <div className="px-5 py-2" id="planogram-accuracy-average-by-geography">
            <div className="p-3 bg-white rounded-lg shadow">
                <ChartHeader
                    title="Planogram Accuracy Average By Geography"
                    cssId="planogram-accuracy-average-by-geography"
...
export default PlanogramAccuracyAvgGeo;
