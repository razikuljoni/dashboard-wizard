...
const PlanogramValidGeo = ({ data }) => {
    ...
    return (
        <div className="px-5 py-2" id="planogram-valid-sequence-average-by-geography">
            <div className="p-3 bg-white rounded-lg shadow">
                <ChartHeader
                    title="Planogram Valid Sequence Average By Geography"
                    cssId="planogram-valid-sequence-average-by-geography"
...
export default PlanogramValidGeo;
