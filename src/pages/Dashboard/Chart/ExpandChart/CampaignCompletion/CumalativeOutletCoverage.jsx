...
const CumalativeOutletCoverage = ({ data }) => {
    ...
    const csvData = dates.map((date, index) => ({
        Date: date,
        Coverage: values[index],
    }));

    return (
        <div className="px-5 py-2" id="cumulative-outlet-campaign-coverage">
            <div className="p-3 bg-white rounded-lg shadow">
                <ChartHeader
                    title="Cumulative Outlet Campaign Coverage"
                    cssId="cumulative-outlet-campaign-coverage"
