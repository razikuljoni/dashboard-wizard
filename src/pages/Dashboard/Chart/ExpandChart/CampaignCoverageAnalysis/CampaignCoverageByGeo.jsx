...
const CampaignCoverageByGeo = ({ data }) => {
    ...
    return (
        <div className="px-5 py-2" id="geography-wise-campaign-coverage-by-date">
            <div className="p-3 bg-white rounded-lg shadow">
                <ChartHeader
                    title="Geography Wise Campaign Coverage By Date"
                    cssId="geography-wise-campaign-coverage-by-date"
