...
const SovSurfaceGeo = ({ data }) => {
    ...
    return (
        <div className="px-5 py-2" id="sov-by-surface-area-by-geography">
            <div className="p-3 bg-white rounded-lg shadow">
                <ChartHeader
                    title="SOV by Surface Area By Geography"
                    cssId="sov-by-surface-area-by-geography"
