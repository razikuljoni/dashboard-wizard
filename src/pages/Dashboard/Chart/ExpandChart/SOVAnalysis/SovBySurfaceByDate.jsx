...
const SovBySurfaceByDate = ({ data }) => {
    ...
    return (
        <div className="px-5 py-2" id="sov-by-surface-area-by-date">
            <div className="p-3 bg-white rounded-lg shadow">
                <ChartHeader
                    title="SOV By Surface Area By Date"
                    cssId="sov-by-surface-area-by-date"
...
export default SovBySurfaceByDate;
