...
const PosmAccuracyAvg = ({ data }) => {
    ...
    return (
        <div className="px-5 py-2" id="posm-accuracy-average-by-date">
            <div className="p-3 bg-white rounded-lg shadow">
                <ChartHeader
                    title="POSM Accuracy Average By Date"
                    cssId="posm-accuracy-average-by-date"
...
export default PosmAccuracyAvg;
