...
const PosmValidGeo = ({ data }) => {
    ...
    return (
        <div className="px-5 py-2" id="posm-valid-sequence-average-by-geography">
            <div className="p-3 bg-white rounded-lg shadow">
                <ChartHeader
                    title="POSM Valid Sequence Average By Geography"
                    cssId="posm-valid-sequence-average-by-geography"
