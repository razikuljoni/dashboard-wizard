        ...
        series: [
            {
                ...
                data: [
                    {
                        value: data?.scanned || 0,
                        name: "Scanned",
                        itemStyle: { color: "#FFC107" },
                    },
                    {
                        value: data?.notScanned || 0,
                        name: "Not Scanned",
    ...
    const csvData = [
        {
            ...
            "Not Scanned": data?.notScanned,
            Total: data?.scanned + data?.totalPMM,
        },
    ];
                        ...
                        <div className="flex justify-center items-center px-3 pt-16 pb-6">
                            ...
                            <div className="text-sm">
                                <p className="flex items-center mb-2 text-[10px]">
                                    ...
                                    Scanned{" "}
                                    <span className="ml-2 font-bold">({data?.scanned || 0})</span>
                                </p>
