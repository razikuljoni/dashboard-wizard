...
const SubChannelWiseScan = ({ data }) => {
    ...
    return (
        <>
            <div className="bg-white shadow rounded-lg h-[285px]" id="sub-channel-wise-scan">
                <ChartHeader
                    title="Sub Channel Wise Scan"
                    setExpandedChart={setExpandedChart}
                    downloadOptions={["PNG", "SVG", "CSV"]}
                    csvData={csvData}
                    cssId="sub-channel-wise-scan"
...
export default SubChannelWiseScan;
