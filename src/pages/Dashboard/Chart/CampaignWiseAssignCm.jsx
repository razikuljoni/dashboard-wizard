...
const CampaignWiseAssignCm = ({ data: posmLifyCycleData, loading }) => {
    const colors = [
        "blue",
        "purple",
        "palevioletred",
    ...
    return (
        <>
            ...
            >
                <ChartHeader
                    title="Campaign Wise Assigned CM"
                ...
                {!isMinimized && (
                    <>
                        {loading ? (
                            <Spin
                                className="flex items-center justify-center h-[230px]"
                                tip="Loading..."
                            />
                        ) : data?.length ? (
                            ...
                            <Empty
                                ...
                                description="No data found for Campaign Wise Assigned CM"
                            />
                        )}
                        {data?.length > 0 ? (
...
export default CampaignWiseAssignCm;
